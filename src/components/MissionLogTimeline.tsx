...
export function MissionLogTimeline() {
  ...
  const timelineData: TimelineItem[] = [
    ...
    {
      id: "LOG-PLACEHOLDER-02",
      yearEn: "[PLACEHOLDER YEARS]",
      yearPt: "[PLACEHOLDER ANOS]",
      roleEn: "[PLACEHOLDER] Certifications & Achievements",
      rolePt: "[PLACEHOLDER] Certificações e Conquistas",
      orgEn: "[ORGANIZATION OR PLATFORM]",
      orgPt: "[ORGANIZAÇÃO OU PLATAFORMA]",
      descEn: "[PLACEHOLDER // YOUR TEXT HERE] Add certificates, course completion records, hackathons, or technical achievements.",
      descPt: "[PLACEHOLDER // SEU TEXTO AQUI] Adicione certificados, cursos concluídos, participação em hackathons ou conquistas técnicas.",
      status: "TEMPLATE",
    },
  ];
