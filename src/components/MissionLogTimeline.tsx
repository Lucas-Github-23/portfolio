...
export function MissionLogTimeline() {
  ...
  const timelineData: TimelineItem[] = [
    ...
    },
    {
      ...
      yearEn: "2023 - 2025",
      yearPt: "2023 - 2025",
      roleEn: "Technical Degree in Systems Development (Integrated with High School)",
      rolePt: "Técnico em Desenvolvimento de Sistemas (Integrado ao Ensino Médio)",
      orgEn: "SANTA MARIA GORETTI C E EF M PROFIS",
      orgPt: "SANTA MARIA GORETTI C E EF M PROFIS",
      descEn: "Technical education integrated with high school, covering software development fundamentals, web applications, programming logic, relational databases, and systems analysis.",
      descPt: "Formação técnica integrada ao Ensino Médio com foco em desenvolvimento de software, lógica de programação, banco de dados, aplicações web e análise de sistemas.",
      status: "COMPLETED",
    },
    {
      id: "LOG-AWARD-01",
