...
export function ProjectDossierGrid() {
  ...
  const projects: ProjectData[] = [
    ...
    {
      id: "OPERATION-02",
      titleEn: "[PLACEHOLDER] YOUR PROJECT 02",
      titlePt: "[PLACEHOLDER] SEU PROJETO 02",
      category: "fullstack",
      clearance: "CLEARANCE LEVEL A-02",
      shortDescEn: "[PLACEHOLDER // DEMO PROJECT] Template card ready for your future full-stack project, academic research, or web app.",
      shortDescPt: "[PLACEHOLDER // PROJETO DEMO] Card modelo pronto para receber seu futuro projeto full-stack, trabalho acadêmico ou web app.",
      fullDescEn: "[PLACEHOLDER DETAILS] Replace this text with your project architecture description, features, database models, and live integration notes.",
      fullDescPt: "[DETALHES DO PLACEHOLDER] Substitua este texto pela descrição da arquitetura do seu projeto, recursos, modelos de banco de dados e notas de deploy.",
